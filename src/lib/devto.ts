...
const username = 'stefanlogue'
const blogURL = 'https://stefanlogue.dev/blog/'
const portfolioURL = 'https://stefanlogue.dev/portfolio/'
...
export const getAllArticles = async (): Promise<IArticle[]> => {
  ...
  const headers = { 'api-key': Config.DEVTO_APIKEY }
